...
WebUI.click(findTestObject('Tracking/Object380_Choose action move back to on-tracking'))

WebUI.click(findTestObject('Tracking/Object381_Confirm move back to on-tracking'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Tracking/moved back to on-tracking.png', FailureHandling.STOP_ON_FAILURE)

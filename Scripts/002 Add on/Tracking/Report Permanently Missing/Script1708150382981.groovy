...
WebUI.click(findTestObject('Tracking/Object375_single action tab on-tracking'))

WebUI.click(findTestObject('Tracking/Object376_Report as permanently Missing'))

WebUI.click(findTestObject('Tracking/Object377_Confirm Report Permanently Missing'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Tracking/Report Permanently Missing.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Tracking/Object378_Tab permanently missing'))

WebUI.delay(5)

WebUI.click(findTestObject('Tracking/Object379_single action tab permanently damaged'))

WebUI.click(findTestObject('Tracking/Object382_Choose Report Disposal'))

WebUI.setText(findTestObject('Tracking/Object383_set note for report disposal'), 'Report Disposal')

WebUI.click(findTestObject('Tracking/Object384_Submit Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(6, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Tracking/Report Disposal from prmantly missing.png', FailureHandling.STOP_ON_FAILURE)

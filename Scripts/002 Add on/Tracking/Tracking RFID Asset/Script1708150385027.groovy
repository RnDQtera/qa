...
WebUI.click(findTestObject('Tracking/Object357_Tracking by RFID'))
...
WebUI.setText(findTestObject('Tracking/Object367_Field Search asset on tab tracked'), 'Blower-RMHO-A - 1')

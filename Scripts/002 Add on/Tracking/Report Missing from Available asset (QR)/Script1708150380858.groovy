...
WebUI.click(findTestObject('Tracking/Object386_select field tag'))

WebUI.click(findTestObject('Tracking/Object387_choose QR tag'))

WebUI.delay(2)

WebUI.click(findTestObject('Tracking/Object386_select field tag'))

WebUI.click(findTestObject('Tracking/Object388_apply filter'))
...
WebUI.setText(findTestObject('Tracking/Object353_Set Text'), 'Report Missing')

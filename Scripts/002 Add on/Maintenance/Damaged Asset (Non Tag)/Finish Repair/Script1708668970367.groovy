...
WebUI.click(findTestObject('Damaged Asset (Non Tag)/Object164_Finish Repair'))

WebUI.click(findTestObject('Damaged Asset (Non Tag)/Object165_Confirm Finish Repair'))

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Damaged and maintenance/Finishrepair.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Damaged Asset (Non Tag)/Object163_Maintenance Log Detail'))

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Damaged and maintenance/maintenancelog.png', FailureHandling.STOP_ON_FAILURE)

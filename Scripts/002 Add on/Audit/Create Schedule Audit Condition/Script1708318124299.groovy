...
WebUI.click(findTestObject('Audit/Object428_Choose Delete for Audit Condition'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Audit/Object408_confirm delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('audit/Create Schedule condition.png', FailureHandling.STOP_ON_FAILURE)

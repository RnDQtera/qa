...
WebUI.click(findTestObject('Audit/Object433_Asset Found Normal Condition'))

WebUI.setText(findTestObject('Audit/Object436_set note'), 'Notes')

WebUI.click(findTestObject('Audit/Object437_Submit'), FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu audit task dan history/Object2095_search'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Menu audit task dan history/Object2096_ketik search cl'), 'legal')

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Menu audit task dan history/Object2096_ketik search cl'), Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.088.003 changelog search audit task.png', FailureHandling.STOP_ON_FAILURE)

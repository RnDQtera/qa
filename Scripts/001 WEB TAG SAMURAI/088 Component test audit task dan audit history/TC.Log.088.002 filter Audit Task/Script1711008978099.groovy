...
WebUI.setText(findTestObject('Menu audit task dan history/Object2091_ketik dt1'), '1')

WebUI.setText(findTestObject('Menu audit task dan history/Object2092_dt2'), '7')

WebUI.click(findTestObject('Menu audit task dan history/Object2093_apply filter'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.088.002 filter audit task.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu audit task dan history/Object2079_ketik search'), 'legal')
...
WebUI.takeScreenshot('Screenshot/TC.Log.088.005 search audit history.png', FailureHandling.STOP_ON_FAILURE)

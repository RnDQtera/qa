...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset missing history/Object0127_download missing history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.023.003 Download missing history.png', FailureHandling.STOP_ON_FAILURE)

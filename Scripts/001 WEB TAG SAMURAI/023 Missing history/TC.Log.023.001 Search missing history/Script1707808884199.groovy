...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset missing history/Object0126_bt search missing history'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset missing history/Object0128_ketik search missing history'), 
    'found')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset missing history/Object0128_ketik search missing history'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.023.001 Search missing history.png', FailureHandling.STOP_ON_FAILURE)

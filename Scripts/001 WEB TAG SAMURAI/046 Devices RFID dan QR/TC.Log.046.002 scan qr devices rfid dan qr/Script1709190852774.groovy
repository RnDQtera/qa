...
WebUI.click(findTestObject('Menu Devices RFID dan QR/Object1088_scan qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.046.002 scan devices qr tag.png', FailureHandling.STOP_ON_FAILURE)

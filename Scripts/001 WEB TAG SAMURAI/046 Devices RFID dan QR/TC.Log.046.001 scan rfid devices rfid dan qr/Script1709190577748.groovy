...
WebUI.click(findTestObject('Menu Devices RFID dan QR/Object1087_scan rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.046.001 scan devices rfid tag .png', FailureHandling.STOP_ON_FAILURE)

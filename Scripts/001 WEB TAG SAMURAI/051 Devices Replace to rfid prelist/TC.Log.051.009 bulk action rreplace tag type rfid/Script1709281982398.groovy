...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object1212_bulk i1'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.051.009 bulk action replace rfid tag.png', FailureHandling.STOP_ON_FAILURE)

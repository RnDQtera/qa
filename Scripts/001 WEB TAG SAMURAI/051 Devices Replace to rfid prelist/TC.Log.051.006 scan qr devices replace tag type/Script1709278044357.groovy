...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object1095_scan rfid'))
...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object1193_scan qr'))

WebUI.delay(5)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.051.006 scan devices qr replace tag type.png', FailureHandling.STOP_ON_FAILURE)

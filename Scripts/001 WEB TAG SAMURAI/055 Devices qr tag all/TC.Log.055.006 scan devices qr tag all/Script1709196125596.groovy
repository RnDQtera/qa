...
WebUI.click(findTestObject('Menu device rfid tag all/Object1021_qr scan'))

WebUI.delay(12)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.041.006 qr scan devices rfid tag all.png', FailureHandling.STOP_ON_FAILURE)

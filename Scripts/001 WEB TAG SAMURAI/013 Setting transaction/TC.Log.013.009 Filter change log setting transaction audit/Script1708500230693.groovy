...
WebUI.click(findTestObject('Setting transactions audit/Object0747_apply filter change log transaction audit'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.013.009 filter change log setting transaction audit.png', FailureHandling.STOP_ON_FAILURE)

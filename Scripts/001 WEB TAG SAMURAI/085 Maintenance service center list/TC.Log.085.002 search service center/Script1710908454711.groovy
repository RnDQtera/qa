...
WebUI.setText(findTestObject('Menu maintenance service center list/Object1942_ketik search'), 'maju')
...
WebUI.takeScreenshot('Screenshot/TC.Log.085.002 search service center.png', FailureHandling.STOP_ON_FAILURE)

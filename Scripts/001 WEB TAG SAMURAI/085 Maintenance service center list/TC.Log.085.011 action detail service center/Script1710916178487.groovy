...
WebUI.click(findTestObject('Menu maintenance service center list/Object1987_detail'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.085.011 action detail service center.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu maintenance service center list/Object1984_act'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.085.009 bulk action active service center.png', FailureHandling.STOP_ON_FAILURE)

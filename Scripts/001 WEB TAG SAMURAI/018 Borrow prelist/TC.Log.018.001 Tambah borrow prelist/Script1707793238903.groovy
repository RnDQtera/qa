...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset borrow prelist/Object0075_bt borrow prelist'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset Transfer prelist/Object0109_ya tambahkan transfer prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.018.001 Tambah borrow prelist.png', FailureHandling.STOP_ON_FAILURE)

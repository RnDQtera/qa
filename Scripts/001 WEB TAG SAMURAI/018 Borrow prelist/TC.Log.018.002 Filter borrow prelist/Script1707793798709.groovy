...
WebUI.click(findTestObject('Page Tag Samurai/Filter borrow prelist/Object0080_bt filter borrow prelist'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.018.002 Filter borrow prelist.png', FailureHandling.STOP_ON_FAILURE)

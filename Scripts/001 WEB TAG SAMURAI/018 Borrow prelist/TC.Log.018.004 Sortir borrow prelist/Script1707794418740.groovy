...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset Transfer prelist/Object0108_sortir brand tf prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.018.004 Sortir borrow prelist.png', FailureHandling.STOP_ON_FAILURE)

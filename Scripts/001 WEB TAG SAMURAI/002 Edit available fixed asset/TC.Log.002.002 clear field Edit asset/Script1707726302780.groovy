...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset edit asset/Object0032_menu edit asset'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset edit asset/Object0033_pilih model type edit'))

WebUI.delay(5)

WebUI.doubleClick(findTestObject('Page Tag Samurai/Fixed asset edit asset/Object0034_pilihan 1 edit model type asset'))

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset edit asset/Object0031_clear field edit asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.002.002 clear field edit asset.png', FailureHandling.STOP_ON_FAILURE)

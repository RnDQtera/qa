...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset edit asset/Object0035_save edited asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.002.001 edit asset.png', FailureHandling.STOP_ON_FAILURE)

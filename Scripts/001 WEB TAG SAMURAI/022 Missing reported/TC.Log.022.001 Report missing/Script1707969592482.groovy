...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset report missing/Object0484_bt report missing'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Fixed asset report missing/Object0486_ketik report missing'), 'test hilang')

WebUI.doubleClick(findTestObject('Page Tag Samurai/Fixed asset report missing/Object0485_submit report missing'))

WebUI.doubleClick(findTestObject('Page Tag Samurai/Fixed asset report missing/Object0487_ya submit report missing'))

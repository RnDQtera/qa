...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset missing reported/Object0499_tracking log missing reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.022.007 Tracking log missing reported.png', FailureHandling.STOP_ON_FAILURE)

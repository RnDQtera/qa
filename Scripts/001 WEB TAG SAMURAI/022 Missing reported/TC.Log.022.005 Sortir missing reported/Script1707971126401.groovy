...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset missing reported/Object0495_sortir group missing reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.022.005 Sortir missing reported.png', FailureHandling.STOP_ON_FAILURE)

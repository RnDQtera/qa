...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset missing reported/Object0494_bt download missing reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.022.004 Download missing reported.png', FailureHandling.STOP_ON_FAILURE)

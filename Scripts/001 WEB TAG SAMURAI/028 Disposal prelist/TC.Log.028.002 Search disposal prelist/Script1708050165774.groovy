...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal prelist/Object0556_bt search disposal prelist'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset disposal prelist/Object0557_ketik search disposal prelist'), 
    'kursi')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset disposal prelist/Object0557_ketik search disposal prelist'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.028.002 Search disposal prelist.png', FailureHandling.STOP_ON_FAILURE)

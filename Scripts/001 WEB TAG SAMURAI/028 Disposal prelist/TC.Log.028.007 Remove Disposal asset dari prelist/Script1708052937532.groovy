...
WebUI.click(findTestObject('Menu titik 3 fixed asset disposal prelist/Object0572_remove disposal prelist'))

WebUI.delay(10)

WebUI.click(findTestObject('Menu titik 3 fixed asset disposal prelist/Object0573_ya hapus disposal prelist'))

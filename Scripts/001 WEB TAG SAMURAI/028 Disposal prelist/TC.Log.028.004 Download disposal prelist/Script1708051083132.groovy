...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal prelist/Object0558_download disposal prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.028.004 Download disposal prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.takeScreenshot('Screenshot/TC.Log.076.025 disposal no salvage value and donate.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.025 disposal no salvage value and donate.png', FailureHandling.STOP_ON_FAILURE)

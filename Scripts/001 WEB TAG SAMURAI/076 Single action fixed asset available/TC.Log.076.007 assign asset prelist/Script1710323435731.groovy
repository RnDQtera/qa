...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1391_assign p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.007 assign asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1390_disposal p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.006 disposal asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

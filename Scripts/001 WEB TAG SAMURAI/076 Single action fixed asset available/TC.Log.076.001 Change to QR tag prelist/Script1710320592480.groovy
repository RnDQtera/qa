...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1383_change to qr p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.001 Change tag to QR Prelist.png', FailureHandling.STOP_ON_FAILURE)

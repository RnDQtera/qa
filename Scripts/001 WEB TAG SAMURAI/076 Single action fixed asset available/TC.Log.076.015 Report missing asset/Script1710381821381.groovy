...
WebUI.click(findTestObject('Fixed asset report missing/Object0484_bt report missing'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.015 Report missing.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.076.015 Report missing.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1392_borrow p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.008 borrow asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

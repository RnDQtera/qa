...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1393_transfer p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.009 transfer asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1388_replace qr p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.004 replace tag to QR Prelist.png', FailureHandling.STOP_ON_FAILURE)

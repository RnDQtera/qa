...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1387_change to rfid qr p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.003 Change tag to RFID & QR Prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu single action fixed asset available/Object1386_change to rfid p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.076.002 Change tag to RFID Prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1582_b unpair tag p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.010 unpair tag asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

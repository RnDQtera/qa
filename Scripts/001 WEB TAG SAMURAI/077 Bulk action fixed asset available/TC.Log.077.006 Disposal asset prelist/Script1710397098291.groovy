...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1578_b disposal'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.006 Disposal asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

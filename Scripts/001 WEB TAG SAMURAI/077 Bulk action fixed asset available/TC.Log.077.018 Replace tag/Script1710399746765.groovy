...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1587_replace tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.018 bulk Replace RFID.png', FailureHandling.STOP_ON_FAILURE)

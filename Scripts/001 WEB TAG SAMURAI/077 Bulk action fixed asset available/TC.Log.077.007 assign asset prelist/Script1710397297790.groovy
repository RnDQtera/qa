...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1579_b assign p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.007 assign asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

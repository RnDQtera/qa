...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1585_b assign asset'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.013 assign asset.png', FailureHandling.STOP_ON_FAILURE)

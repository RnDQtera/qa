...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1589_unpair tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.020 bulk Unpair tag.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1583_b borrow'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.011 borrow asset.png', FailureHandling.STOP_ON_FAILURE)

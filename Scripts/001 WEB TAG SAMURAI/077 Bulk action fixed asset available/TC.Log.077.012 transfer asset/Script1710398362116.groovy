...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1584_b tf'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.012 transfer asset.png', FailureHandling.STOP_ON_FAILURE)

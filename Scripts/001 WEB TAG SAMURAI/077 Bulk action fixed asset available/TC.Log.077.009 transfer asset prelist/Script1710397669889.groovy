...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1581_b tf p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.009 transfer asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

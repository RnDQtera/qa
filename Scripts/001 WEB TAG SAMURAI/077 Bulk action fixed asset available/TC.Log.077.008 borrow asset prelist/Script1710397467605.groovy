...
WebUI.click(findTestObject('Menu bulk action fixed asset available/Object1580_b borrow p'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.077.008 borrow asset Prelist.png', FailureHandling.STOP_ON_FAILURE)

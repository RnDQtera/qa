...
WebUI.click(findTestObject('Menu devices rfid tag damaged missing/Object0826_event log mdamaged missing'))

WebUI.click(findTestObject('Menu devices RFID Tag Available/Object0813_bt search log rfid avail'))

WebUI.delay(4)

WebUI.setText(findTestObject('Menu devices RFID Tag Available/Object0814_ketik search log rfid avail'), 'audit')
...
WebUI.takeScreenshot('Screenshot/TC.Log.045.003 search devices rfid tag damaged missing.png', FailureHandling.STOP_ON_FAILURE)

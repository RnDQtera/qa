...
WebUI.click(findTestObject('Menu maintenance repair permanently damaged/Object1896_m log'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.083.007 maintenance log.png', FailureHandling.STOP_ON_FAILURE)

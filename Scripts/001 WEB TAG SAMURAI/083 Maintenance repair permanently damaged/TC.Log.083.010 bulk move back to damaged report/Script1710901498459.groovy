...
WebUI.click(findTestObject('Menu maintenance repair permanently damaged/Object1903_bulk move back'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.083.010 bulk move back.png', FailureHandling.STOP_ON_FAILURE)

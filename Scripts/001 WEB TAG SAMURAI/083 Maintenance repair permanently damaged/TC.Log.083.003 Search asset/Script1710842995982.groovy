...
WebUI.setText(findTestObject('Menu maintenance maintenable asset/Object1598_ketik search'), 'truk')
...
WebUI.takeScreenshot('Screenshot/TC.Log.083.003 Search.png', FailureHandling.STOP_ON_FAILURE)

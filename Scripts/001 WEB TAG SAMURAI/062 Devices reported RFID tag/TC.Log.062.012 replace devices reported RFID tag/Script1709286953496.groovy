...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1226_replace rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.012 replace devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

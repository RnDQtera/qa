...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1224_bulk change'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.010 bulk action change devices reported RFID to qr.png', FailureHandling.STOP_ON_FAILURE)

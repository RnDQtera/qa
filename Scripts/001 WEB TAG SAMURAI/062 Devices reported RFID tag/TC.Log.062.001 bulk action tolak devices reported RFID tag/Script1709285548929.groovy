...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1221_bulk i5'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.001 bulk action tolak devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

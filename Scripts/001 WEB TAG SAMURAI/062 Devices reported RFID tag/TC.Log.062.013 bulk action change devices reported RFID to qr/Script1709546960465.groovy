...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1266_bulk action change to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.013 bulk action change devices reported rfid to qr.png', FailureHandling.STOP_ON_FAILURE)

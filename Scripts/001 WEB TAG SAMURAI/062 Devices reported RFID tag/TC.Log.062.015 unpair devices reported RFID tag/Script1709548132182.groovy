...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1274_unpair tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.015 unpair devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

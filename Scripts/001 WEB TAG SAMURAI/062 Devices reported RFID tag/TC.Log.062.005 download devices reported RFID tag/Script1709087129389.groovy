...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object0925_download'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.062.005 download devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

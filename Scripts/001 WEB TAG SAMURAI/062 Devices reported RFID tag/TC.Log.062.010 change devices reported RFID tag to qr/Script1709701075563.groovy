...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1277_change to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.010 change devices reported RFID to qr.png', FailureHandling.STOP_ON_FAILURE)

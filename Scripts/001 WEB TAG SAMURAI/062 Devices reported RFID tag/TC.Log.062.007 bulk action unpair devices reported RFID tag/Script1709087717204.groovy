...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object0939_unpair tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.007 bulk action unpair devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

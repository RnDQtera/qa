...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1115_sync now'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices reported RFID tag/Object1116_close sync'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.062.003 scan devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

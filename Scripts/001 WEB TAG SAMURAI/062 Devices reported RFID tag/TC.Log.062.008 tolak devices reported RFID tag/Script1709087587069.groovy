...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object0935_decline report'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices reported RFID tag/Object0936_ya lanjutkan'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.062.008 tolak devices reported RFID.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices prelist pair tag to qr/Object0903_pair qr tag menu'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.058.003 filter devices qr tag pair prelist.png', FailureHandling.STOP_ON_FAILURE)

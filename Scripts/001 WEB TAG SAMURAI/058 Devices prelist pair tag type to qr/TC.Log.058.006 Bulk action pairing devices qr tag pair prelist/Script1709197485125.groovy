...
WebUI.click(findTestObject('Menu devices prelist pair tag to qr/Object0903_pair qr tag menu'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object1096_bulk action pairing rfid'))

WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object0900_apply bulk action'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object1097_scan rfid veriv'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object1098_sync now'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object1099_close sync'))
...
WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object1100_submit veriv'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.058.006 bulk action pair devices qr tag pair prelist.png', FailureHandling.STOP_ON_FAILURE)

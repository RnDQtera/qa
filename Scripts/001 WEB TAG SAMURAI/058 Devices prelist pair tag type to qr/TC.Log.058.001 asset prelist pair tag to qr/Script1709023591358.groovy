...
WebUI.click(findTestObject('Menu devices prelist pair tag to qr/Object0902_prelist pair to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.058.001 asset prelist pair tag to qr.png', FailureHandling.STOP_ON_FAILURE)

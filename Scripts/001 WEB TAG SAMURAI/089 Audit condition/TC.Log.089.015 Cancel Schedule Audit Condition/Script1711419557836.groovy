...
WebUI.takeScreenshot('Screenshot/TC.Log.089.015 cancel audit schedule condition.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.089.015 cancel audit schedule condition.png', FailureHandling.STOP_ON_FAILURE)

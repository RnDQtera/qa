...
WebUI.click(findTestObject('Menu audit condition/Object2146_event log'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.089.005 action audit log audit condition.png', FailureHandling.STOP_ON_FAILURE)

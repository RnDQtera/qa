...
WebUI.click(findTestObject('Page Tag Samurai/Setting custom field/Object0341_sortir custom field'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.011.002 Sortir table custom field.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0359_assign category custom field'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0360_checkbox assign category custom field'))

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0368_save assign category custom field'))

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0370_ya assign category'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.011.009 Assign category custom field.png', FailureHandling.STOP_ON_FAILURE)

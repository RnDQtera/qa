...
WebUI.click(findTestObject('Page Tag Samurai/Setting custom field/Object0332_download custom field'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.011.005 Download custom field.png', FailureHandling.STOP_ON_FAILURE)

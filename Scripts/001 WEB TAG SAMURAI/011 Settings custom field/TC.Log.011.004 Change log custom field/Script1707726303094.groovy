...
WebUI.click(findTestObject('Page Tag Samurai/Setting custom field/Object0331_change log custom field'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.011.004 Change log custom field.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0362_delete custom field'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting custom field/Object0371_ya hapus custom field'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.011.008 Hapus custom field.png', FailureHandling.STOP_ON_FAILURE)

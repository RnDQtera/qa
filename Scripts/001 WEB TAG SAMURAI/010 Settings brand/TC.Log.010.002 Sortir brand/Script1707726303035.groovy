...
WebUI.click(findTestObject('Page Tag Samurai/Setting brand/Object0309_sortir kategori brand'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.002 Sortir brand.png', FailureHandling.STOP_ON_FAILURE)

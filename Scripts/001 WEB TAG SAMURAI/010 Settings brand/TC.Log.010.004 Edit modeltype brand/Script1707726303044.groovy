...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0318_edit modeltype brand'))

WebUI.delay(10)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0326_tambah modeltype brand'))

WebUI.setText(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0321_ketik modeltype brand1'), 'Street')

WebUI.delay(8)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0324_submit edit brand'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.004 Edit brand.png', FailureHandling.STOP_ON_FAILURE)

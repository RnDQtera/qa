...
WebUI.click(findTestObject('Page Tag Samurai/Setting brand/Object0302_detail brand'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.010 detail brand.png', FailureHandling.STOP_ON_FAILURE)

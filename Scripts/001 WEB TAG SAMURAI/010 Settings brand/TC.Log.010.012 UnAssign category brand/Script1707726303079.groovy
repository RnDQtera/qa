...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0328_unassign cat brand'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.012 unAssign kategori brand.png', FailureHandling.STOP_ON_FAILURE)

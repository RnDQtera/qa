...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0319_edit nama brand'))

WebUI.delay(10)

WebUI.setText(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0320_ketik edit nama brand'), 'Edited')

WebUI.delay(8)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0325_submit edit nama brand'))

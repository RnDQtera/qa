...
WebUI.click(findTestObject('Page Tag Samurai/Setting brand/Object0301_change log brand'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.006 Change log brand.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0316_assign kategori brand'))

WebUI.delay(10)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0322_pilih kategori brand 4'))

WebUI.delay(8)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting brand/Object0323_submit assign cat brand'))

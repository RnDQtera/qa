...
WebUI.click(findTestObject('Page Tag Samurai/Setting brand/Object0303_download list brand'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.010.007 Download brand.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0866_sortir nama'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.053.001 sortir devices replace prelist qr dan rfid.png', FailureHandling.STOP_ON_FAILURE)

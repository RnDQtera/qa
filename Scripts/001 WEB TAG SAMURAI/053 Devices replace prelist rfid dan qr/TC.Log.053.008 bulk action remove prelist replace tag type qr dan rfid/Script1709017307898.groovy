...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0878_remove from prelist'))
...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0880_ya apply bulk action'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.053.008 bulk action remove prelist replace rfid dan qr tag.png', FailureHandling.STOP_ON_FAILURE)

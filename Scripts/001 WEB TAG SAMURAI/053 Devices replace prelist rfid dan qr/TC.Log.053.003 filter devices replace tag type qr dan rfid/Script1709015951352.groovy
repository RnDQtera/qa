...
WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0867_bt filter'))

WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0868_select asset name'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu devices replace rfid prelis/Object0869_checkbox asset name'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.053.003 filter devices replace prelist rfid dan qr tag.png', FailureHandling.STOP_ON_FAILURE)

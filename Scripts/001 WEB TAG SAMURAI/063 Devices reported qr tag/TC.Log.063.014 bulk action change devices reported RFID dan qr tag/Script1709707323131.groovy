...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object1267_change to rfid dan qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.063.014 bulk action change devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

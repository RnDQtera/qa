...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset Transfer history/Object0067_download tf history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.017.003 Download transfer history.png', FailureHandling.STOP_ON_FAILURE)

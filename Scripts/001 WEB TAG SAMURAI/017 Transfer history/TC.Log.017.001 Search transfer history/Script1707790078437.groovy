...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset Transfer history/Object0066_bt search tf history'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset Transfer history/Object0068_ketik search tf history'), 'kursi')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset Transfer history/Object0068_ketik search tf history'), Keys.chord(
        Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.017.001 search transfer history.png', FailureHandling.STOP_ON_FAILURE)

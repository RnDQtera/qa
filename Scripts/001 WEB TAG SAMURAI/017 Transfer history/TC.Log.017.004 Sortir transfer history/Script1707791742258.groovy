...
WebUI.click(findTestObject('Menu fixed asset disposal history (1)/Menu fixed asset Transfer history/Object0070sortir nama tf history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.017.004 Sortir transfer history.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu titik 3 fixed asset Transfer history/Object0076_titik 3 tf history'))

WebUI.click(findTestObject('Menu titik 3 fixed asset Transfer history/Object0075_bt transfer log'))

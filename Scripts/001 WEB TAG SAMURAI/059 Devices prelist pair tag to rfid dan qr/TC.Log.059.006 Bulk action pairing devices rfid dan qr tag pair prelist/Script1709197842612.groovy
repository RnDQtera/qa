...
WebUI.click(findTestObject('Menu devices prelist change to rfid dan qr/Object1102_scan 2'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.059.006 bulk action pair devices rfid dan qr tag pair prelist.png', FailureHandling.STOP_ON_FAILURE)

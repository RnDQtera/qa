...
WebUI.click(findTestObject('Menu fixed asset borrow borrowed/Object2232_act return'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Menu fixed asset borrow borrowed/Object2233_submit return'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.020.005 return borrow borrowed.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.020.005 return borrow borrowed.png', FailureHandling.STOP_ON_FAILURE)

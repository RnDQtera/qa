...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1195_prelist change to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.012 prelist change to qr tag.png', FailureHandling.STOP_ON_FAILURE)

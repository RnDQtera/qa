...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1198_prelist replace'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.013 prelist replace to rfid.png', FailureHandling.STOP_ON_FAILURE)

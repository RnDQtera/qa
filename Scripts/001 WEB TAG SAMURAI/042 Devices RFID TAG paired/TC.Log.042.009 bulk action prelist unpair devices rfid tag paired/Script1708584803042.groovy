...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object0791_i4 bulk action devices rfid tag paired'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.009 bulk action prelist unpair devices rfid tag paired.png', FailureHandling.STOP_ON_FAILURE)

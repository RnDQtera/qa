...
WebUI.setText(findTestObject('Menu devices rfid tag paired/Object0789_ketik search devices rfid tag paired'), 'laptop')
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.005 search devices rfid tag paired.png', FailureHandling.STOP_ON_FAILURE)

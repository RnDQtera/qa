...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object0790_i3 bulk action devices rfid tag paired'))

WebUI.click(findTestObject('Menu devices rfid tag paired/Object0786_apply bulk action devices rfid tag paired'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices rfid tag paired/Object0787_ya apply bulk action devices rfid tag paired'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.042.008 bulk action prelist replace devices rfid tag paired.png', FailureHandling.STOP_ON_FAILURE)

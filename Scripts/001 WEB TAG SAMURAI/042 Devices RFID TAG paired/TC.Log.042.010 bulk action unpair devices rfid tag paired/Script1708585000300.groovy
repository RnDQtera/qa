...
WebUI.setText(findTestObject('Menu devices rfid tag paired/Object0789_ketik search devices rfid tag paired'), 'AC-RMHO')
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.010 bulk action unpair devices rfid tag paired.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1261_replace tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.019 replace to rfid.png', FailureHandling.STOP_ON_FAILURE)

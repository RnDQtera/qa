...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object0785_i1 bulk action devices rfid tag paired'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.007 bulk action prelist change devices rfid tag paired.png', FailureHandling.STOP_ON_FAILURE)

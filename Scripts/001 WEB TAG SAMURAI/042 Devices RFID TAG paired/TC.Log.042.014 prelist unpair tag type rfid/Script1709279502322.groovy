...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1199_prelist unpair'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.042.014 prelist unpair to rfid.png', FailureHandling.STOP_ON_FAILURE)

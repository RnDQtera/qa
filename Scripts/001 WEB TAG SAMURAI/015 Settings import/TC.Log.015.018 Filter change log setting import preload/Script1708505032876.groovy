...
WebUI.click(findTestObject('Setting import preload/Object0750_apply filter changelog import preload'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.015.018 filter change log setting import preload.png', FailureHandling.STOP_ON_FAILURE)

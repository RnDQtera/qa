...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0266_pilihan 1 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.001 Download data template group.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0272_pilihan 7 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.007 Download data template user.png', FailureHandling.STOP_ON_FAILURE)

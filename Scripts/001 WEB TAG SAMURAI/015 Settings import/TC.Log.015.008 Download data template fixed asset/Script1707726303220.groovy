...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0273_pilihan 8 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.008 Download data template fixed asset.png', FailureHandling.STOP_ON_FAILURE)

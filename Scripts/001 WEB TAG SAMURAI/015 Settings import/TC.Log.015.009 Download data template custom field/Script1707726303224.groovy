...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0274_pilihan 9 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.009 Download data template custom field.png', FailureHandling.STOP_ON_FAILURE)

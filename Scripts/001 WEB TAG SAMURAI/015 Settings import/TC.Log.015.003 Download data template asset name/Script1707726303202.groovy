...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0268_pilihan 3 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.003 Download data template asset name.png', FailureHandling.STOP_ON_FAILURE)

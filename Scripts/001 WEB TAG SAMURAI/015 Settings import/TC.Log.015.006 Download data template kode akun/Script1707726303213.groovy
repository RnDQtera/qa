...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0271_pilihan 6 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.006 Download data template kode akun.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0267pilihan 2 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.002 Download data template category.png', FailureHandling.STOP_ON_FAILURE)

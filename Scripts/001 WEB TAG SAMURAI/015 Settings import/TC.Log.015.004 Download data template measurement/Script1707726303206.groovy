...
WebUI.click(findTestObject('Page Tag Samurai/Setting import download template file/Object0269_pilihan 4 data template'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.015.004 Download data template measurement.png', FailureHandling.STOP_ON_FAILURE)

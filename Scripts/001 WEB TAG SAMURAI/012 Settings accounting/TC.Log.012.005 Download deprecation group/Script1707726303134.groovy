...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0438_download deprecation group'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.005 Download deprecation group.png', FailureHandling.STOP_ON_FAILURE)

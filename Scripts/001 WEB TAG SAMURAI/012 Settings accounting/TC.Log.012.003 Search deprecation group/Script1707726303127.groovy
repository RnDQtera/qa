...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0436_bt search deprecation group'))

WebUI.setText(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0440_ketik search deprecation group'), 
    'test')

WebUI.delay(3)

WebUI.sendKeys(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0440_ketik search deprecation group'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.003 Search deprecation group.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0443_sortir nama deprecation group'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.002 Sortir deprecation group.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0439_dropdown metode depresiasi'))

WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0441_pilihan 1 dropdown metode depresiasi'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0442_save metode depresiasi'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.009 Memilih deprecation group.png', FailureHandling.STOP_ON_FAILURE)

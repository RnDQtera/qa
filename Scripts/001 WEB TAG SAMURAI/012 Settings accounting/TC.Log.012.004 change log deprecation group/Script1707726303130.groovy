...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting depreciation setting/Object0437_change log deprecation group'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.004 Change log deprecation group.png', FailureHandling.STOP_ON_FAILURE)

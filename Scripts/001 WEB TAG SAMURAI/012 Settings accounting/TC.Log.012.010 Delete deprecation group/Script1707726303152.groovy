...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting accounting depreciation setting/Object0457_delete deprecation group'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.012.010 Hapus deprecation group.png', FailureHandling.STOP_ON_FAILURE)

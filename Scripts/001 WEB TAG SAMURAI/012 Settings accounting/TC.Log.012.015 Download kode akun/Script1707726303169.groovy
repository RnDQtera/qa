...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting account code list/Object0465_download kode akun'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.015 Download kode akun.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting accounting account code list/Object0463_bt search kode akun'))

WebUI.setText(findTestObject('Page Tag Samurai/Setting accounting account code list/Object0466_ketik search kode akun'), '00')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Setting accounting account code list/Object0466_ketik search kode akun'), Keys.chord(
        Keys.ENTER))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.013 Search kode akun.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting accounting acc code list/Object0473_delete kode akun'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting accounting acc code list/Object0479_ya hapus kode akun'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.012.017 Hapus kode akun.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign asset/Object0511_bt download fixed asset assign prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.024.004 Download assign prelist.png', FailureHandling.STOP_ON_FAILURE)

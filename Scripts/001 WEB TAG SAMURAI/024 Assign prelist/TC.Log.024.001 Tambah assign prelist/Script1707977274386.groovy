...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign prelist/Object0502_bt assign prelist'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign prelist/Object0503_tambahkan assign prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.024.001 Tambah assign prelist.png', FailureHandling.STOP_ON_FAILURE)

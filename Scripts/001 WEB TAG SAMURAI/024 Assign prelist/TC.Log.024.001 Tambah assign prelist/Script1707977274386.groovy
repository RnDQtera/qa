...
WebUI.click(findTestObject('Menu fixed asset assign prelist/Object0502_bt assign prelist'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu fixed asset assign prelist/Object0503_tambahkan assign prelist'))

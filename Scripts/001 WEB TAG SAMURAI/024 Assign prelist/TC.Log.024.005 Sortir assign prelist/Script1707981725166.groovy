...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign asset/Object0512_sortir nama fixed asset assign prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.024.005 Sortir assign prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu audit task dan history/Object2245_cb 2 tipe aud'))
...
WebUI.click(findTestObject('Menu audit task dan history/Object2254_cb2 stop'))

WebUI.setText(findTestObject('Menu audit task dan history/Object2253_note stop'), 'ok berhenti')

WebUI.click(findTestObject('Menu audit task dan history/Object2252_submit'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.091.002 stop audit overdue condition.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.091.002 stop audit overdue condition.png', FailureHandling.STOP_ON_FAILURE)

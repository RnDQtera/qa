...
WebUI.takeScreenshot('Screenshot/TC.Log.091.004 stop audit overdue existence.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.091.004 stop audit overdue existence.png', FailureHandling.STOP_ON_FAILURE)

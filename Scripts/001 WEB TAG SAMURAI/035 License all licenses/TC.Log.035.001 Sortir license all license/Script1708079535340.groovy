...
WebUI.click(findTestObject('Page Tag Samurai/1 Object0653_menu atas license'))

WebUI.delay(12)

WebUI.click(findTestObject('Page Tag Samurai/Menu license all licenses/Object0654_sortir fixed asset license al'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.035.001 Sortir license all licenses.png', FailureHandling.STOP_ON_FAILURE)

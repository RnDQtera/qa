...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object0910_sortir unpair tag'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.070.001 sortir devices tag unpair history.png', FailureHandling.STOP_ON_FAILURE)

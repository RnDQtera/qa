...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object1013_download history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.070.003 download devices tag unpair history.png', FailureHandling.STOP_ON_FAILURE)

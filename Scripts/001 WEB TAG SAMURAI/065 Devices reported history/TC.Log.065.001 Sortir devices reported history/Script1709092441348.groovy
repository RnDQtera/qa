...
WebUI.click(findTestObject('Menu devices reported history/Object0955_sortir nama'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.065.001 sortir devices reported history.png', FailureHandling.STOP_ON_FAILURE)

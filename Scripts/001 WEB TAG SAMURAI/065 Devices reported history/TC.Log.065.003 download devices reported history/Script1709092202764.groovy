...
WebUI.click(findTestObject('Menu devices reported history/Object0954_download'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.065.003 download devices reported history.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0529_sortir status assign transaction'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.025.004 Sortir assign transaction.png', FailureHandling.STOP_ON_FAILURE)

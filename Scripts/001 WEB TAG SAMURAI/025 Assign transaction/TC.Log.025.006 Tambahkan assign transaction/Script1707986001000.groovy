...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0532_tambahkan assign asset'))

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0533_pilih asset untuk assign asset'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0534_checkbox i1 pilih asset untuk assign'))

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0535_select asset dipilih untuk assign'))

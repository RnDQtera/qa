...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign transaction/Object0528_download assign transaction'))

WebUI.delay(5)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.025.003 Download assign transaction.png', FailureHandling.STOP_ON_FAILURE)

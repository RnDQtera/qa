...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset register asset/Object0012_stay on form tambah asset'))

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset register asset/Object0011_save asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.001.003 Check stay on this form.png', FailureHandling.STOP_ON_FAILURE)

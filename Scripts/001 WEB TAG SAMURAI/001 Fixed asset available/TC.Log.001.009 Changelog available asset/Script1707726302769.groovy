...
WebUI.doubleClick(findTestObject('Page Tag Samurai/Menu available asset/Object0060_button menu available asset'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu available asset/Object0062_change log avail asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.001.009 Changelog available asset.png', FailureHandling.STOP_ON_FAILURE)

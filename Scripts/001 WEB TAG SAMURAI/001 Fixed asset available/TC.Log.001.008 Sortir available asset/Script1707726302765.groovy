...
WebUI.click(findTestObject('Page Tag Samurai/Menu available asset/Object0065sortir nama avail asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.001.008 Sortir available asset.png', FailureHandling.STOP_ON_FAILURE)

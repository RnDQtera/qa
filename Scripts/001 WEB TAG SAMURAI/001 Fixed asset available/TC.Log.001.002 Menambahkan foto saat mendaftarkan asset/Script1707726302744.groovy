...
WebUI.uploadFile(findTestObject('Page Tag Samurai/Fixed asset register asset/Object0014_upload foto'), 'C:\\Users\\aplikasi internal\\Pictures\\Saved Pictures\\kursiolympic.jpg')

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset register asset/Object0016_apply upload foto'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.001.002 Menambahkan gambar saat Mendaftarkan asset.png', FailureHandling.STOP_ON_FAILURE)

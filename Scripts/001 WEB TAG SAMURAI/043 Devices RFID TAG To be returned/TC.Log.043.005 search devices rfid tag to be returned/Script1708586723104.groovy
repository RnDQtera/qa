...
WebUI.setText(findTestObject('Menu devices rfid tag paired/Object0789_ketik search devices rfid tag paired'), 'router')
...
WebUI.takeScreenshot('Screenshot/TC.Log.043.005 search devices rfid tag to be returned.png', FailureHandling.STOP_ON_FAILURE)

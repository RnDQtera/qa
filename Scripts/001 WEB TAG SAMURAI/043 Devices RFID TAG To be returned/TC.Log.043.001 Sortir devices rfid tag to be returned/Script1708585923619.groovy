...
WebUI.click(findTestObject('Menu devices rfid tag to be returned/Object0796_sortir rfid tag to be returned'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.043.001 sortir devices rfid tag to be returned.png', FailureHandling.STOP_ON_FAILURE)

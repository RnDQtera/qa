...
WebUI.click(findTestObject('Menu devices rfid tag to be returned/Object0797_apply filter rfid tag to be returned'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.043.003 filter devices rfid tag to be returned.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1077_scan qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.043.006 scan qr devices rfid tag to be return .png', FailureHandling.STOP_ON_FAILURE)

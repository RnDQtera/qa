...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0625_download damage reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.033.004 download damage reported.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0623_bt search damage reported'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0624_ketik search damage reported'), 
    'kursi')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0624_ketik search damage reported'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.033.002 Search damage reported.png', FailureHandling.STOP_ON_FAILURE)

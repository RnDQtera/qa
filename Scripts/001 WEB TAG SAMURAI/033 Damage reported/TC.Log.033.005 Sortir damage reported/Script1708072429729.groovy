...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0626_sortir damage reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.033.005 Sortir damage reported.png', FailureHandling.STOP_ON_FAILURE)

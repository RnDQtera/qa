...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0631_bt damage reported'))

WebUI.delay(3)

WebUI.uploadFile(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0632_upload foto damage reported'), 
    'C:\\Users\\aplikasi internal\\Downloads\\objek repo.jpg')

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0634_apply upload foto damage reported'))

WebUI.delay(3)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0633_isi text damage reported'), 'test report')

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0635_submit damage reported'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage reported/Object0636_ya laporkan kerusakan'))

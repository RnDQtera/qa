...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset damage reported/Object0637_titik 3 damage reported'))

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset damage reported/Object0641_report disposal damage reported'))

WebUI.delay(8)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset damage reported/Object0640_submit damage reported'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.033.007 Report disposal damage reported.png', FailureHandling.STOP_ON_FAILURE)

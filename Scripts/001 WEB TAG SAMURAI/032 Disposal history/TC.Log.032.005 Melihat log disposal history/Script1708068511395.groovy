...
WebUI.click(findTestObject('Menu titik 3 fixed asset disposal history/Object0620_titik 3 disposal history'))

WebUI.click(findTestObject('Menu titik 3 fixed asset disposal history/Object0621_bt disposal log'))

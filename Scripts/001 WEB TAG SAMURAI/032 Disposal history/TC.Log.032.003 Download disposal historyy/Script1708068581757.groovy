...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal history/Object0614_download disposal history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.032.003 Download disposal history.png', FailureHandling.STOP_ON_FAILURE)

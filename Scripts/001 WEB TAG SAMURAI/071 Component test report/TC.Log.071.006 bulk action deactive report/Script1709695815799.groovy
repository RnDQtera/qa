...
WebUI.click(findTestObject('Menu report/Object1434_bt bulk act'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report/Object1435_deactive'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report/Object1436_apply bulk act'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report/Object1437_konfirm bulk action'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.071.006 bulk action deactive report.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu report/Object1438_activate'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.071.007 bulk action active report.png', FailureHandling.STOP_ON_FAILURE)

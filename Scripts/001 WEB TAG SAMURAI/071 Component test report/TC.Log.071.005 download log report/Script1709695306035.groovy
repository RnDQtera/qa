...
WebUI.click(findTestObject('Menu report/Object1432_download log'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.071.005 download log report.png', FailureHandling.STOP_ON_FAILURE)

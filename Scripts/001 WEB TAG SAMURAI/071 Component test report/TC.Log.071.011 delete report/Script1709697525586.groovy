...
WebUI.setText(findTestObject('Menu report/Object1404_ketik search'), 'copy')
...
WebUI.click(findTestObject('Menu report/Object1446_delete report'))

WebUI.delay(5)

WebUI.click(findTestObject('Menu report/Object1445_ya lanjutkan'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.071.011 delete report.png', FailureHandling.STOP_ON_FAILURE)

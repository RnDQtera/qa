...
WebUI.click(findTestObject('Menu report/Object1439_delete'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.071.008 bulk action delete report.png', FailureHandling.STOP_ON_FAILURE)

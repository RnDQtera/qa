...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset policy/Object0298_sortir nama asset policy'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.008.002 sortir tabel asset policy.png', FailureHandling.STOP_ON_FAILURE)

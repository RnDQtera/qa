...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset policy/Object0293_download asset policy'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.008.004 download asset policy.png', FailureHandling.STOP_ON_FAILURE)

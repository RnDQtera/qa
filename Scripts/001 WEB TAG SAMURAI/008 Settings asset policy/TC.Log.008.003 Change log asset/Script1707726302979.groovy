...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset policy/Object0292_change log asset policy'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.008.003 Change log asset policy.png', FailureHandling.STOP_ON_FAILURE)

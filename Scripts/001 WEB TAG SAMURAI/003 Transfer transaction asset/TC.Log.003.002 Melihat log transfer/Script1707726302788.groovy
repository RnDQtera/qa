...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0153_titik 3 transaction'))

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0154_transaction detail'))

WebUI.delay(10)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0151_titik 3 detail tr'))

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0155_transfer log'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.003.002 Melihat log transfer.png', FailureHandling.STOP_ON_FAILURE)

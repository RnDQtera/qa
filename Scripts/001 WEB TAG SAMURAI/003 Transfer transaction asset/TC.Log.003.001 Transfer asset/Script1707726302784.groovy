...
WebUI.click(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0038_available transfer'))

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0046_select group transfer'))

WebUI.doubleClick(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0050_transfer group index 4'))

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0036_apply asset transfer'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0047_submit asset transfer'))

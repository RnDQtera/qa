...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0149_cancel tf ts'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0157_ya lanjutkan cancel tf ts'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.003.008 Cancel transfer transaction.png', FailureHandling.STOP_ON_FAILURE)

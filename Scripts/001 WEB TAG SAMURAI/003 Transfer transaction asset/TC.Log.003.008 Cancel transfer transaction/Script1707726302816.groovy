...
WebUI.click(findTestObject('Menu titik 3 fixed asset transfer transaction/Object0149_cancel tf ts'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu titik 3 fixed asset transfer transaction/Object0157_ya lanjutkan cancel tf ts'))

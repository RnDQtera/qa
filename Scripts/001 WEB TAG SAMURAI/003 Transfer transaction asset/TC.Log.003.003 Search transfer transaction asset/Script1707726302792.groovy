...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset transfer transaction/Object0117_bt search tf ts'))

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset transfer transaction/Object0119_ketik search tf ts'), 'kursi')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset transfer transaction/Object0119_ketik search tf ts'), Keys.chord(
        Keys.ENTER))

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0147_abort handover tf ts'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset transfer transaction/Object0156_ya abort handover tf ts'))

...
WebUI.click(findTestObject('Menu titik 3 fixed asset transfer transaction/Object0150_submit handover tf ts'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu titik 3 fixed asset transfer transaction/Object0158_ya lanjutkan handover tf ts'))

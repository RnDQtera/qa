...
WebUI.setText(findTestObject('Menu devices prelist change tag to type RFID/Object0846_ketik search'), 'laptop')
...
WebUI.takeScreenshot('Screenshot/TC.Log.047.005 search devices change to rfid tag.png', FailureHandling.STOP_ON_FAILURE)

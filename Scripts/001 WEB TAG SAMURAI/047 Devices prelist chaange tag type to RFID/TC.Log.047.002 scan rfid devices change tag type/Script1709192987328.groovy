...
WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object1093_scan rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.047.002 scan devices rfid change tag type.png', FailureHandling.STOP_ON_FAILURE)

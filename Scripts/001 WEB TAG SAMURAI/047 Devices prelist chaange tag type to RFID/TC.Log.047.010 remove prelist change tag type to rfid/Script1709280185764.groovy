...
WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object1204_remove prelist'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object1205_ya lanjutkan'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.047.010 remove prelist change to rfid tag.png', FailureHandling.STOP_ON_FAILURE)

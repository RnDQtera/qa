...
WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object1094_can qr'))

WebUI.delay(5)

WebUI.click(findTestObject('Menu devices rfid tag paired/Object1078_sync now'))

WebUI.delay(5)

WebUI.click(findTestObject('Menu devices rfid tag paired/Object1079_close sync'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.047.006 scan devices qr change tag type.png', FailureHandling.STOP_ON_FAILURE)

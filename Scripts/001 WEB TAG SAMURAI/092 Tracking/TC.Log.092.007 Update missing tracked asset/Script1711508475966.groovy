...
'jika tidak bisa scan tag, ganti dengan 2288'
WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Menu tracking/Object2289_cb misisng'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.092.007 Update missing tracked.png', FailureHandling.STOP_ON_FAILURE)

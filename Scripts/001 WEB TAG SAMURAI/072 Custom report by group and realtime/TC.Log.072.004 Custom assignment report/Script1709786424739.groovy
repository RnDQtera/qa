...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan assignment group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.004 create assignment report group realtime.png', FailureHandling.STOP_ON_FAILURE)

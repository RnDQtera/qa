...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tracking group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.005 create tracking report group realtime.png', FailureHandling.STOP_ON_FAILURE)

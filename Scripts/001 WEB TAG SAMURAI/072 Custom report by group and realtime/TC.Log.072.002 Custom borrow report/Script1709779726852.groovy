...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan borrow group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.002 create borrow report group realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan damaged group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.013 create damaged report group realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Audit/Object448_Field seacrh change log audit'), 'SAUD-240319-0001')

WebUI.sendKeys(findTestObject('Audit/Object448_Field seacrh change log audit'), Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.087.005 search changelog audit schedule.png', FailureHandling.STOP_ON_FAILURE)

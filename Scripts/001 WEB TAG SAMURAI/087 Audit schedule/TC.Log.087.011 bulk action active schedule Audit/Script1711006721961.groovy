...
WebUI.click(findTestObject('Menu audit schedule/Object2075_active'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.Log.087.011 bulk action active audit schedule.png', FailureHandling.STOP_ON_FAILURE)

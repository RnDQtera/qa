...
WebUI.click(findTestObject('Menu audit schedule/Object2076_delete'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.Log.087.012 bulk action delete audit schedule.png', FailureHandling.STOP_ON_FAILURE)

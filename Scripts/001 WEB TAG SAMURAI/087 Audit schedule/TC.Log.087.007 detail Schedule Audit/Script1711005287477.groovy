...
WebUI.click(findTestObject('Menu audit schedule/Object2063_detail'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.087.007 detail audit schedule.png', FailureHandling.STOP_ON_FAILURE)

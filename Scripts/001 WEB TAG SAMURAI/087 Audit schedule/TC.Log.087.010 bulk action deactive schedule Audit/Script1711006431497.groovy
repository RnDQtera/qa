...
WebUI.click(findTestObject('Menu audit schedule/Object2072_cb 1 sch'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Menu audit schedule/Object2073_bulk act'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Menu audit schedule/Object2074_deact'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Menu audit schedule/Object2077_apply bulk'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.Log.087.010 bulk action deactive audit schedule.png', FailureHandling.STOP_ON_FAILURE)

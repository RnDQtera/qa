...
WebUI.setText(findTestObject('Audit/Object445_Field Search'), 'SAUD-240319-0001')
...
WebUI.takeScreenshot('Screenshot/TC.Log.087.003 search audit schedule.png', FailureHandling.STOP_ON_FAILURE)

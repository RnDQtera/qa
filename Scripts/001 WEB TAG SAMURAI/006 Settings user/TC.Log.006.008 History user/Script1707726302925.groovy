...
WebUI.click(findTestObject('Page Tag Samurai/Setting user/Object0195_change log user'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.006.008 change log user.png', FailureHandling.STOP_ON_FAILURE)

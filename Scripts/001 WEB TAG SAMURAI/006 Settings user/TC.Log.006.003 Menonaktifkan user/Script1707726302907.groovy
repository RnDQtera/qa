...
WebUI.doubleClick(findTestObject('Page Tag Samurai/Setting user/Object0204_on off aktif user'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.006.003 Menonaktifkan user.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting user/Object0221_edit user'))

WebUI.delay(8)

WebUI.setText(findTestObject('Page Tag Samurai/Menu titik 3 setting user/Object0220_edit last name'), 'edited')

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting user/Object0223_submit edit user'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.006.011 edit user.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting user/Object0197_download user'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.006.009 Download user.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset-categories asset name/Object0405_sortir nama kategori asset'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.002 Sortir kategori asset.png', FailureHandling.STOP_ON_FAILURE)

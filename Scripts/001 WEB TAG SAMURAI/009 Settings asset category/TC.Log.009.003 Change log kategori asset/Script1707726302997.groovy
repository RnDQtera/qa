...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset-categories asset name/Object0397_change log kategori asset'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.003 Changelog kategori asset.png', FailureHandling.STOP_ON_FAILURE)

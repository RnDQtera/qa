...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting asset-categories asset name/Object0420_edit kategori asset'))

WebUI.delay(3)

WebUI.setText(findTestObject('Page Tag Samurai/Menu titik 3 setting asset-categories asset name/Object0421_ketik edited text'), 'edited')

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting asset-categories asset name/Object0426_submit edited text'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.006 Edit kategori asset.png', FailureHandling.STOP_ON_FAILURE)

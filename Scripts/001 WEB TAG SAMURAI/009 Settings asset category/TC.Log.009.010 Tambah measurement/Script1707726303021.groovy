...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset-categories measurement/Object0415_tambah measurement'))

WebUI.delay(3)

WebUI.setText(findTestObject('Page Tag Samurai/Setting asset-categories measurement/Object0412_ketik nama measurement'), 'Until')

WebUI.click(findTestObject('Page Tag Samurai/Setting asset-categories measurement/Object0414_submit tambah measurement'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.010 Tambah measurement.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Setting asset-categories asset name/Object0397_change log kategori asset'))
...
WebUI.click(findTestObject('Setting asset-categories asset name/Object0741_apply filter change log asset categories'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.013 filter change log asset categories.png', FailureHandling.STOP_ON_FAILURE)

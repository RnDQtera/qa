...
WebUI.click(findTestObject('Page Tag Samurai/Setting asset-categories asset name/Object0398_download kategori asset'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.004 Download kategori asset.png', FailureHandling.STOP_ON_FAILURE)

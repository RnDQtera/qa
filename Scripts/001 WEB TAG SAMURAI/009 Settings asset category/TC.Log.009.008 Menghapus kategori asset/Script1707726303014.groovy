...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting asset-categories asset name/Object0416_delete kategori asset'))

WebUI.delay(3)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting asset-categories asset name/Object0428_ya hapus kategori asset'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.009.008 Delete kategori asset.png', FailureHandling.STOP_ON_FAILURE)

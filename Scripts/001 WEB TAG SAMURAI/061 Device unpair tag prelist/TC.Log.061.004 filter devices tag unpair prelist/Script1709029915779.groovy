...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object0911_bt filter'))

WebUI.click(findTestObject('Menu devices unpair tag prelist/Object0912_dropdown filter'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.061.003 filter devices tag unpair prelist.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object0909_unpair tag prelist'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.061.001 asset prelist unpair tag.png', FailureHandling.STOP_ON_FAILURE)

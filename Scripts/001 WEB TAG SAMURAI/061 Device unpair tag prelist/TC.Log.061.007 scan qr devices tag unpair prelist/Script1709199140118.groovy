...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object1103_scan rfid'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices unpair tag prelist/Object1104_sync rfid'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices unpair tag prelist/Object1105_close sync'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices unpair tag prelist/Object1106_scan qr'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.061.007 scan qr devices tag unpair prelist.png', FailureHandling.STOP_ON_FAILURE)

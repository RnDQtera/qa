...
WebUI.click(findTestObject('Menu devices unpair tag prelist/Object0915_download unpair prelist'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.061.004 download devices tag unpair prelist.png', FailureHandling.STOP_ON_FAILURE)

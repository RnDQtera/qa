...
WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1732_scan qr'))

WebUI.delay(8)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.080.002 Scan qr tag.png', FailureHandling.STOP_ON_FAILURE)

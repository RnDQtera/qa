...
WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1750_changelog'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1753_bt filter cl'))
...
WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1754_select group'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1755_lt 1'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1756_apply grop'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance routine scheduled task/Object1757_apply filter'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.080.007 filter changelog.png', FailureHandling.STOP_ON_FAILURE)

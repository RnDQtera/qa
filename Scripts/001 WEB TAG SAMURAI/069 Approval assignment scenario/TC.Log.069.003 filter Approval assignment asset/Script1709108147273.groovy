...
WebUI.click(findTestObject('Menu approval assignment/Object1003_bt filter'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.Log.069.003 filter approval assignment asset.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal disposed asset/Object0603_sortir disposed asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.031.004 Sortir disposal disposed asset.png', FailureHandling.STOP_ON_FAILURE)

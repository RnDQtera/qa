...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal disposed asset/Object0600_bt search disposed asset'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset disposal disposed asset/Object0601_ketik search disposed asset'), 
    'missing')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset disposal disposed asset/Object0601_ketik search disposed asset'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.031.001 Search disposal dsposed asset.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset disposed asset/Object0604_bt filter disposed asset'))

WebUI.delay(10)

WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset disposed asset/Object0605_dropdown filter nama disposed asset'))

WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset disposed asset/Object0606_checkbox filter disposed asset'))

WebUI.delay(8)

WebUI.doubleClick(findTestObject('Page Tag Samurai/Filter fixed asset disposed asset/Object0607_apply filter disposed asset'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.031.002 Filter disposal disposed asset.png', FailureHandling.STOP_ON_FAILURE)

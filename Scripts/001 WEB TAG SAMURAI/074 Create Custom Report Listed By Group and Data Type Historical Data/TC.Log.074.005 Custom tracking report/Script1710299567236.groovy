...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tracking group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.005 create tracking report group historical.png', FailureHandling.STOP_ON_FAILURE)

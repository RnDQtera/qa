...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan assignment group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.004 create assignment report group historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan borrow group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.002 create borrow report group historical.png', FailureHandling.STOP_ON_FAILURE)

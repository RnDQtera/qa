...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan audit group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.006 create audit report group historical.png', FailureHandling.STOP_ON_FAILURE)

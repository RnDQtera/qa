...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan damaged group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.013 create damaged report group historical.png', FailureHandling.STOP_ON_FAILURE)

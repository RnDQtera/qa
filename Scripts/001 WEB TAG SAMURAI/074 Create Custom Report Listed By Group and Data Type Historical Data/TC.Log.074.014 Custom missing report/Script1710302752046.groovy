...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan missing group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.014 create missing report group historical.png', FailureHandling.STOP_ON_FAILURE)

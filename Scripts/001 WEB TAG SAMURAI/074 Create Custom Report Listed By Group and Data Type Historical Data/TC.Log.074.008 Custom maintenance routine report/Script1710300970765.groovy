...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan maintenance routine group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.008 create maintenance routine report group historical.png', FailureHandling.STOP_ON_FAILURE)

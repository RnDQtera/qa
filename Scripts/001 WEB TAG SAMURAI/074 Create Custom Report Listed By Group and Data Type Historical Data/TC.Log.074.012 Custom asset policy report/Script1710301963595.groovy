...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan asset policy group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.012 create asset policy report group historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan maintenance repair group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.009 create maintenance repair report group historical.png', FailureHandling.STOP_ON_FAILURE)

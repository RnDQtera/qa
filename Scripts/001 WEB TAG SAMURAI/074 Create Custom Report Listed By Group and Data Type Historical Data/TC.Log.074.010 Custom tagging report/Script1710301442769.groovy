...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tagging group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.010 create tagging report group historical.png', FailureHandling.STOP_ON_FAILURE)

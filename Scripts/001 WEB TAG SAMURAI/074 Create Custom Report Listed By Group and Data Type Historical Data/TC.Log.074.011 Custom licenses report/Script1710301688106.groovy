...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan license group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.011 create license report group historical.png', FailureHandling.STOP_ON_FAILURE)

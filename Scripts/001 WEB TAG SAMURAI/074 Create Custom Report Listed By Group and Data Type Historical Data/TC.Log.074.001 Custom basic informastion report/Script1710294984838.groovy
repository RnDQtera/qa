...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan basic group historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.001 create basic info report group historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan disposal group historical')
...
WebUI.setText(findTestObject('Menu report create tracking group realtime/Object1292_ketik aset name'), 'kurs')
...
WebUI.takeScreenshot('Screenshot/TC.Log.074.007 create disposal report group historical.png', FailureHandling.STOP_ON_FAILURE)

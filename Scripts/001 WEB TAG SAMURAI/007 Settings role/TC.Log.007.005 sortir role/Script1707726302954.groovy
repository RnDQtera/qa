...
WebUI.click(findTestObject('Page Tag Samurai/Setting role/Object0253_sortir nama role'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.007.005 sortir role.png', FailureHandling.STOP_ON_FAILURE)

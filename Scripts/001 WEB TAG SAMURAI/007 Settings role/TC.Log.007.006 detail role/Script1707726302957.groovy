...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 setting role/Object0257_detail role'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.007.006 detail role.png', FailureHandling.STOP_ON_FAILURE)

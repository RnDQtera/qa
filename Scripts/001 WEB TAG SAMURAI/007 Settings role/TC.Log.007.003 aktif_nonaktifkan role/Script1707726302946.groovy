...
WebUI.click(findTestObject('Page Tag Samurai/Setting role/Object0237_aktif_nonaktifkan role'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Setting role/Object0256_ya aktif_nonaktifkan role'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.007.003 aktif_menonaktifkan role.png', FailureHandling.STOP_ON_FAILURE)

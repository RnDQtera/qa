...
WebUI.click(findTestObject('Page Tag Samurai/Setting role/Object0242_checkbox filter role 1'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.007.008 filter user.png', FailureHandling.STOP_ON_FAILURE)

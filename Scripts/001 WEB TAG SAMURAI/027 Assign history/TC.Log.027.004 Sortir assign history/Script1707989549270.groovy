...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign history/Object0546_sortir nama assign history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.027.004 Sortir assign history.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign history/Object0545_download assign history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.027.003 Download assign history.png', FailureHandling.STOP_ON_FAILURE)

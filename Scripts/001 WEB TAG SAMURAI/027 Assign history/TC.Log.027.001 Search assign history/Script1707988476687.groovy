...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset assign history/Object0543_bt search assign history'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset assign history/Object0544_ketik search assign history'), 
    'kursi')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset assign history/Object0544_ketik search assign history'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.027.001 Search assign history.png', FailureHandling.STOP_ON_FAILURE)

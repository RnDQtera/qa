...
WebUI.setText(findTestObject('Page Tag Samurai/Fixed asset transfer asset/Object0042_ketik menu filter nama available'), 'kursi')
...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset borrow transaction/Object0133_bt borrow available'))

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset borrow transaction/Object0138_select user borrow transaction'))

WebUI.doubleClick(findTestObject('Page Tag Samurai/Menu fixed asset borrow transaction/Object0136_pilih select user borrow transaction'))

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset borrow transaction/Object0131_apply select user bt'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset borrow transaction/Object0140_submit borrow transaction'))

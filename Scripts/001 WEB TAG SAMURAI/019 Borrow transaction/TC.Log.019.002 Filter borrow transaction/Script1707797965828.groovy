...
WebUI.click(findTestObject('Page Tag Samurai/Filter borrow transaction/Object0142_filter borrow transaction'))
...
WebUI.click(findTestObject('Page Tag Samurai/Filter borrow transaction/Object0141_apply filter bt'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.019.002 Filter borrow transaction.png', FailureHandling.STOP_ON_FAILURE)

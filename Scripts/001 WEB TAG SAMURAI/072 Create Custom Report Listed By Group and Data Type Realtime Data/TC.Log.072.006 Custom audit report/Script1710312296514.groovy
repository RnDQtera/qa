...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan audit group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.006 create audit report group realtime.png', FailureHandling.STOP_ON_FAILURE)

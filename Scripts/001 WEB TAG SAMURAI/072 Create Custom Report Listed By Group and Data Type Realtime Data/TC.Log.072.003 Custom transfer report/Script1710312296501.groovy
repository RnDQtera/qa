...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan transfer group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.003 create transfer report group realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan license group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.011 create license report group realtime.png', FailureHandling.STOP_ON_FAILURE)

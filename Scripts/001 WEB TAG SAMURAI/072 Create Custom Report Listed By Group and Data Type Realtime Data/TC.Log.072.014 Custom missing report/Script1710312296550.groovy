...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan missing group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.014 create missing report group realtime.png', FailureHandling.STOP_ON_FAILURE)

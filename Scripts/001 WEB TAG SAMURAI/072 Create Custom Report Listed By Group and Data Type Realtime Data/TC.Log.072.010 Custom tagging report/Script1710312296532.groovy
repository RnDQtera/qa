...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tagging group realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.072.010 create tagging report group realtime.png', FailureHandling.STOP_ON_FAILURE)

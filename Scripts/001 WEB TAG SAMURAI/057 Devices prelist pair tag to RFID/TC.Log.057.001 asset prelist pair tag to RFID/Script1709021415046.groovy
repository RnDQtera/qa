...
WebUI.click(findTestObject('Menu devices prelist pair tag to rfid/Object0886_add prelist pair rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.057.001 asset prelist pair tag to rfid.png', FailureHandling.STOP_ON_FAILURE)

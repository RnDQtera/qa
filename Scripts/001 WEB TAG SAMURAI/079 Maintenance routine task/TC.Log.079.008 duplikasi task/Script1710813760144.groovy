...
WebUI.click(findTestObject('Menu maintenance task/Object1721_duplikat'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance task/Object1722_save dupe'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.079.008 duplikasi task.png', FailureHandling.STOP_ON_FAILURE)

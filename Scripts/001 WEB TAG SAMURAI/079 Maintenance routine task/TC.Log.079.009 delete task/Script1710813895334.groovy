...
WebUI.click(findTestObject('Menu maintenance task/Object1723_delete task'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu maintenance task/Object1724_ya hapus'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.079.009 delete task.png', FailureHandling.STOP_ON_FAILURE)

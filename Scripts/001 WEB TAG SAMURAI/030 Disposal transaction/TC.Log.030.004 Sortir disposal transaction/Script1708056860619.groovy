...
WebUI.doubleClick(findTestObject('Menu fixed asset disposal transaction/Object0584_sortir disposal transaction'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.030.004 Sortir disposal transaction.png', FailureHandling.STOP_ON_FAILURE)

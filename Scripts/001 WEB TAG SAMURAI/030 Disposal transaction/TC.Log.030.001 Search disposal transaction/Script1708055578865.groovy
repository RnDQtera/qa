...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset disposal transaction/Object0585_bt search disposal transaction'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page Tag Samurai/Menu fixed asset disposal transaction/Object0586_ketik search disposal transaction'), 
    'donate')

WebUI.sendKeys(findTestObject('Page Tag Samurai/Menu fixed asset disposal transaction/Object0586_ketik search disposal transaction'), 
    Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.030.001 Search disposal transaction.png', FailureHandling.STOP_ON_FAILURE)

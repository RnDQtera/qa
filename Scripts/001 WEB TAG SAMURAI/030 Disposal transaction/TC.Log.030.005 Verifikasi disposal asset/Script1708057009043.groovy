...
WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset disposal transaction/Object0592_verivikasi disposal transaction'))

WebUI.delay(8)

WebUI.click(findTestObject('Page Tag Samurai/Menu titik 3 fixed asset disposal transaction/Object0593_submit verifikasi disposal transaction'))

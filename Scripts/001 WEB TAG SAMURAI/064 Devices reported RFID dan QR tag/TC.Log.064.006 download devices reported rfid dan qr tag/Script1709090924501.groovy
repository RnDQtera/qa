...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object0950_download'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.064.006 download devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

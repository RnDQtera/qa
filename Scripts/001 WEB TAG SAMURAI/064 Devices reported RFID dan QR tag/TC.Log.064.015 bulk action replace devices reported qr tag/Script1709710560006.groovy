...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1283_replace to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.015 bulk action replace devices reported to qr.png', FailureHandling.STOP_ON_FAILURE)

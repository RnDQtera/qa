...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1278_bulk action change to rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.012 bulk action change devices reported rfid dan QR TO RFID.png', FailureHandling.STOP_ON_FAILURE)

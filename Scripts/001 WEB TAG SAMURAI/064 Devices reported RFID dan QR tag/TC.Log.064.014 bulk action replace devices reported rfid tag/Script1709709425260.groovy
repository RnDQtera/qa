...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1280_replace rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.014 bulk action replace devices reported rfid.png', FailureHandling.STOP_ON_FAILURE)

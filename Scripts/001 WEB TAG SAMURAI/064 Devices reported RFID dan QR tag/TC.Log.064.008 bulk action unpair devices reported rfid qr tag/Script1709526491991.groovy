...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1322_bulk unpair tag'))

WebUI.click(findTestObject('Menu devices reported RFID tag/Object0940_apply bulk action'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1323_submit bulk unpair'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.008 bulk action unpair devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

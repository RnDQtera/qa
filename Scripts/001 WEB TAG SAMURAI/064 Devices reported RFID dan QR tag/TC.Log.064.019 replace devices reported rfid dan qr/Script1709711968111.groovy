...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1286_replace rfid dan qr'))
...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1282_scan kanan replace'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.019 replace devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

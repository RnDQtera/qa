...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1285_replace rfid'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.018 replace devices reported rfid.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1281_replace rfid dan qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.016 bulk action replace devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

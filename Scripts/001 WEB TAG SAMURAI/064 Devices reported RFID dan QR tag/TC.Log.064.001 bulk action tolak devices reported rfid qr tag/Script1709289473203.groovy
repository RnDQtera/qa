...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1227_bulk decline'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.001 bulk action tolak devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

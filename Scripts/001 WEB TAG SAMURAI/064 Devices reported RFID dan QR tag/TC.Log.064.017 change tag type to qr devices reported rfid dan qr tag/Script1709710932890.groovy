...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1284_change to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.017 change tag type to qr devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1279_change to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.013 bulk action change devices reported rfid dan QR TO qr.png', FailureHandling.STOP_ON_FAILURE)

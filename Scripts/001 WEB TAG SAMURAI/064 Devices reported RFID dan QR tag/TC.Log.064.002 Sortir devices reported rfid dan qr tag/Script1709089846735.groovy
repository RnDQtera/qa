...
WebUI.click(findTestObject('Menu devices reported RFID tag/Object0924_sortir nama reported rfid'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.064.002 sortir devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

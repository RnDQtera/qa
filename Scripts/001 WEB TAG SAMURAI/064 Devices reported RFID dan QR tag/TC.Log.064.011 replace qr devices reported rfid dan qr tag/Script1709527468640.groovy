...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1234_repplace qr tag'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.011 replace devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1245_change tag to RFID'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.064.010 change tag type to rfid devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

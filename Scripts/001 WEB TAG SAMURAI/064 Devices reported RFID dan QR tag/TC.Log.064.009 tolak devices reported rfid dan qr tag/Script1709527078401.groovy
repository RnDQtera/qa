...
WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1325_tolak laporan'))

WebUI.delay(3)

WebUI.click(findTestObject('Menu devices reported RFID dan qr tag/Object1233_ya lanjutkan'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.064.009 tolak devices reported rfid dan qr.png', FailureHandling.STOP_ON_FAILURE)

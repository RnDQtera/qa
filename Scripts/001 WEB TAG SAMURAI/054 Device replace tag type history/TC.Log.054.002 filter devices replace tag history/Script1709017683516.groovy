...
WebUI.click(findTestObject('Menu devices history change tag/Object1167_cb i3'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.054.002 filter devices replace tag history.png', FailureHandling.STOP_ON_FAILURE)

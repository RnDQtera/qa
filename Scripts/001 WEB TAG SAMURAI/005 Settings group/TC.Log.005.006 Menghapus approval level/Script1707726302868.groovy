...
WebUI.click(findTestObject('Page Tag Samurai/Menu setting group borrowing assignment role/Object0376_hapus approval level'))

WebUI.click(findTestObject('Page Tag Samurai/Menu setting group borrowing assignment role/Object0383_yes delete approval leve'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.005.006 Menghapus approval level.png', FailureHandling.STOP_ON_FAILURE)

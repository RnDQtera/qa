...
WebUI.click(findTestObject('Menu devices RFID Tag Available/Object1082_bt scan transfer'))

WebUI.delay(5)

WebUI.click(findTestObject('Menu devices RFID Tag Available/Object1085_scan tf'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.044.007 scan devices rfid tag transfer.png', FailureHandling.STOP_ON_FAILURE)

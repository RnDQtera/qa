...
WebUI.click(findTestObject('Menu devices RFID Tag Available/Object0815_download log rfid avail'))

WebUI.delay(4)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.044.005 download devices rfid tag available.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1252_change tag type to qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.056.017 change to RFID.png', FailureHandling.STOP_ON_FAILURE)

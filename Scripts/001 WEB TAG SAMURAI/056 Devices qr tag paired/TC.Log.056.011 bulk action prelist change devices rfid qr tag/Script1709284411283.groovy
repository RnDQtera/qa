...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1194_bulk action i2 change to rfid qr'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.056.011 bulk action prelist change devices rfid qr tag paired.png', FailureHandling.STOP_ON_FAILURE)

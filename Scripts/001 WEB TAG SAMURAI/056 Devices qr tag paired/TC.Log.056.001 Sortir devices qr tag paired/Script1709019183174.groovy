...
WebUI.click(findTestObject('Menu devices qr tag all/Object0884_Menu devices qr tag all'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.Log.056.001 sortir devices qr tag paired.png', FailureHandling.STOP_ON_FAILURE)

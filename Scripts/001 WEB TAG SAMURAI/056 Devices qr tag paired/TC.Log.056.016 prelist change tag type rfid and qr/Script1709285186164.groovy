...
WebUI.click(findTestObject('Menu devices rfid tag paired/Object1203_change rfid and qr'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu devices rfid tag paired/Object1197_ya lanjutkan'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.056.016 prelist change to rfid n qr.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage history/Object0650_Sortir nama damage history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.034.004 Sortir damage reported.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Menu fixed asset damage history/Object0649_download damage history'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.034.003 Download damage reported.png', FailureHandling.STOP_ON_FAILURE)

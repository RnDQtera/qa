...
WebUI.click(findTestObject('Menu maintenance service center activities/Object2029_download'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.086.003 download service center activites.png', FailureHandling.STOP_ON_FAILURE)

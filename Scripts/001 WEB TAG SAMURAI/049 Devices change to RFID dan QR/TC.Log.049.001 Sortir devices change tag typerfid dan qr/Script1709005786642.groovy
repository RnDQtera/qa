...
WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object0839_sortir nama'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.049.001 sortir devices prelist to RFID dan qr tag.png', FailureHandling.STOP_ON_FAILURE)

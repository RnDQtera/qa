...
WebUI.click(findTestObject('Menu devices prelist change tag to type RFID/Object0844_download'))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.049.004 download devices prelist to rfid dan qr tag.png', FailureHandling.STOP_ON_FAILURE)

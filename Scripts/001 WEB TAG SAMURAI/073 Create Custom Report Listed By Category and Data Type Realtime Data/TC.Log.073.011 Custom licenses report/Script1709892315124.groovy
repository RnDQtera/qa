...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan license category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.011 create license report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan maintenance routine category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.008 create maintenance routine report category realtime.png', FailureHandling.STOP_ON_FAILURE)

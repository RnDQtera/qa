...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan audit category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.006 create audit report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan borrow category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.002 create borrow report category realtime.png', FailureHandling.STOP_ON_FAILURE)

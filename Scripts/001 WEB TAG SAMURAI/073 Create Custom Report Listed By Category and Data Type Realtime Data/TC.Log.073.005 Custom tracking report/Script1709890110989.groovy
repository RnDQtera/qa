...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tracking category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.005 create tracking report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan assignment category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.004 create assignment report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan missing categoy realtime')
...
WebUI.setText(findTestObject('Menu report create transfer group realtime/Object1563_ketik manager trf'), 'laur')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.014 create missing report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan transfer category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.003 create transfer report category realtime.png', FailureHandling.STOP_ON_FAILURE)

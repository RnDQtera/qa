...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan maintenance repair category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.009 create maintenance repair report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan basic category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.001 create basic info report category realtime.png', FailureHandling.STOP_ON_FAILURE)

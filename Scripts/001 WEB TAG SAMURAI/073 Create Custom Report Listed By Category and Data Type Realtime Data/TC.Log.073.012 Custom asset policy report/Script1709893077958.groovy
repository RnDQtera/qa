...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan asset policy category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.012 create asset policy report category realtime.png', FailureHandling.STOP_ON_FAILURE)

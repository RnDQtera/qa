...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan tagging category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.010 create tagging report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan damaged category realtime')
...
WebUI.takeScreenshot('Screenshot/TC.Log.073.013 create damaged report category realtime.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan audit category historical')
...
WebUI.click(findTestObject('Menu report create audit group realtime/Object1304_cb audit'))
...
WebUI.setText(findTestObject('Menu report create tracking group realtime/Object1292_ketik aset name'), 'fil')
...
WebUI.setText(findTestObject('Menu report create borrow group realtime/Object1518_ketik asset name'), 'esun')
...
WebUI.setText(findTestObject('Menu report create transfer group realtime/Object1553_ketik model'), 'esun')
...
WebUI.click(findTestObject('Menu report create audit group realtime/Object1303_date'))
...
WebUI.setText(findTestObject('Menu report create transfer group realtime/Object1563_ketik manager trf'), 'normal')
...
WebUI.takeScreenshot('Screenshot/TC.Log.075.006 create audit report category historical.png', FailureHandling.STOP_ON_FAILURE)

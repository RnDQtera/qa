...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan damaged category historical')
...
WebUI.click(findTestObject('Menu report create damaged group realtime/Object1347_cb damaged'))
...
WebUI.doubleClick(findTestObject('Menu report create damaged group realtime/Object1353_mundur'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report create damaged group realtime/Object1354_tgl 1'))

WebUI.click(findTestObject('Menu report create damaged group realtime/Object1355_tgl 31'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.075.013 create damaged report category historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan asset policy category historical')
...
WebUI.takeScreenshot('Screenshot/TC.Log.075.012 create asset policy report category historical.png', FailureHandling.STOP_ON_FAILURE)

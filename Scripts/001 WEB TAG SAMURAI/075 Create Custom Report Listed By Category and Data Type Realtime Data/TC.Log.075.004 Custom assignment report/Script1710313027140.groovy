...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan assignment category historical')
...
WebUI.click(findTestObject('Menu report create assignment group realtime/Object1566_cb info assignment'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.075.004 create assignment report category historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Menu report/Object1448_ketik nama laporan'), 'Laporan missing category historical')
...
WebUI.click(findTestObject('Menu report create missings group realtime/Object1356_Menu report create missing group realtime'))
...
WebUI.click(findTestObject('Menu report create damaged group realtime/Object1351_clear field'))
...
WebUI.setText(findTestObject('Menu report create borrow group realtime/Object1518_ketik asset name'), 'kursi')
...
WebUI.setText(findTestObject('Menu report create transfer group realtime/Object1563_ketik manager trf'), 'laurent')
...
WebUI.click(findTestObject('Menu report create damaged group realtime/Object1352_date'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report create damaged group realtime/Object1353_mundur'))

WebUI.delay(2)

WebUI.click(findTestObject('Menu report create missings group realtime/Object1357_tgl 1'))

WebUI.click(findTestObject('Menu report create missings group realtime/Object1358_tgl 29'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.075.014 create missing report category historical.png', FailureHandling.STOP_ON_FAILURE)

...
WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset assignment asset/Object0539_bt filter assignment asset'))

WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset assignment asset/Object0540_dropdown filter assignment asset'))

WebUI.delay(5)

WebUI.click(findTestObject('Page Tag Samurai/Filter fixed asset assignment asset/Object0541_apply filter assignment asset'))

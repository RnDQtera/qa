...
WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1818_ketik search'), 'internal')
...
WebUI.click(findTestObject('Menu maintenance repair damaged report/Object1877_result cb1'))

WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1878_ketik note'), 'mantap')

WebUI.click(findTestObject('Menu maintenance repair damaged report/Object1879_cb cost'))

WebUI.delay(3)

WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1880_ketik nama service'), 'full kang')

WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1881_ketik qty'), '5')

WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1882_harga'), '5050505')

WebUI.click(findTestObject('Menu maintenance repair damaged report/Object1883_submit'))
...
WebUI.takeScreenshot('Screenshot/TC.Log.082.011 completion.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/Notifikasi/TC.Log.082.011 completion.png', FailureHandling.STOP_ON_FAILURE)

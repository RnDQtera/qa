...
WebUI.click(findTestObject('Menu maintenance repair damaged report/Object1816_scan qr'))

WebUI.delay(3)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.Log.082.002 Scan qr tag.png', FailureHandling.STOP_ON_FAILURE)

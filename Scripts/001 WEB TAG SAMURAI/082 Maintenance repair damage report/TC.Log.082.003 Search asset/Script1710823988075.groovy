...
WebUI.setText(findTestObject('Menu maintenance repair damaged report/Object1818_ketik search'), 'truk')
...
WebUI.takeScreenshot('Screenshot/TC.Log.082.003 Search.png', FailureHandling.STOP_ON_FAILURE)
